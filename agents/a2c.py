...
class A2C(BaseAgent):
    def __init__(self,
        ...
        super(A2C, self).__init__(env, policy, logger, storage, device, n_checkpoints)

        self.n_steps = n_steps
        self.n_envs = n_envs
        self.gamma = gamma
        self.lmbda = lmbda
        self.optimizer = optim.RMSprop(self.policy.parameters(), lr=learning_rate, alpha=0.99, eps=1e-5)
    ...
    def optimize(self):
        ...
        for sample in generator:
            ...
            value_loss = 0.5 * F.smooth_l1_loss(value_batch, return_batch.detach())

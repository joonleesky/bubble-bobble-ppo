import torch
import common.data_aug as data_aug
...
class Storage():
    ...
    def store(self, obs, act, rew, done, log_prob_act, value, random_shift = True):
        ...
        if random_shift:
            self.obs_batch[self.step] = data_aug.random_shift(self.obs_batch[self.step])
